...
return {
	...
	{var = "rampMode", type = "check", label = "Calculate Ailments post ramp", tooltip = "Some Ailments can ramp. An example would be shock, where the increased damage given by shock can increase the shock effect even further.\n\tWhen this is enabled, Ailment modifiers will be calculated post ramp\n\tWARNING: This can severly slow down the simulation", apply = function(val,modList,enemyModList)
		modList:NewMod("Condition:CalculateAfterRamp", "FLAG", true, "Config")
	end },
...
Huge sets the radius to 11.
	...
	{ var = "skillPierceCount", type = "count", label = "# of times Skill has Pierced:", ifStat = "PierceCount", ifFlag = "piercing", apply = function(val, modList, enemyModList)
